...
def create_model():
    ...
    lstm = keras.layers.Bidirectional(keras.layers.LSTM(128, return_sequences=True, dropout=0.15))(city_embedding)
    gru = keras.layers.Bidirectional(keras.layers.GRU(128, return_sequences=False, dropout=0.15))(lstm)
    ...
    dense_categorical = keras.layers.Dense(512)(batch_normalized_categorical)
